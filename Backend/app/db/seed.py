...
def create_sample_data():
    ...
    try:
        ...
        ratings_data = [
            ...
            {"course_id": course1.id, "device_id": "device-001", "score": 5},
            {"course_id": course1.id, "device_id": "device-002", "score": 4},
            {"course_id": course1.id, "device_id": "device-003", "score": 4},
            # Curso de Python: 2 ratings (promedio 3.5)
            {"course_id": course2.id, "device_id": "device-004", "score": 3},
            {"course_id": course2.id, "device_id": "device-005", "score": 4},
            # Curso de JavaScript: 1 rating
            {"course_id": course3.id, "device_id": "device-006", "score": 5},
            # Curso sin ratings: no se agregan datos
        ]

        for rating_data in ratings_data:
            rating = Rating(
                course_id=rating_data["course_id"],
                device_id=rating_data["device_id"],
